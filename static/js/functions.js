...
function checkLang(){
    ...
    if(typeof GOFLY_LANG!="undefined" && typeof GOFLY_LANG_CURRENT!="undefined"){
        return GOFLY_LANG_CURRENT;
    }
    return "cn";
}
function t(key){
    var lang=checkLang();
    if(typeof GOFLY_LANG!="undefined" && GOFLY_LANG[lang] && GOFLY_LANG[lang][key]){
        return GOFLY_LANG[lang][key];
    }
    return key;
}
function getLangObj(){
    var lang=checkLang();
    if(typeof GOFLY_LANG!="undefined" && GOFLY_LANG[lang]){
        return GOFLY_LANG[lang];
    }
    return GOFLY_LANG["cn"];
}
